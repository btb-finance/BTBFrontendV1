...
import { FetchRadiumResult } from "@/lib/types/home/radium";
import { PAGE_SIZE } from "@/lib/utils/home/radium_constants";
import { PoolTypeKey, poolTypes } from "@/lib/utils/home/radium_constants";
    ...
    data.forEach((pool) => {
      ...
      if (prev) {
        newChanges[pool.id] = {
          ...
          volume: calculatePercentageChange(prev.day.volume, pool.day.volume), 
          volumeFee: calculatePercentageChange(
            prev.day.volumeFee,
            pool.day.volumeFee
          ), 
          apr: calculatePercentageChange(prev.day.apr, pool.day.apr), 
        };
      }
    });
      ...
      >
        ...
        <div className="overflow-x-auto shadow-lg rounded-lg">
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr>
                <th key="pool" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer transition-all duration-200 hover:bg-gray-700 hover:text-white">
                  Pool
                </th>
                <th key="tvl" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer transition-all duration-200 hover:bg-gray-700 hover:text-white">
                  TVL
                </th>
                <th key="volume" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer transition-all duration-200 hover:bg-gray-700 hover:text-white">
                  Volume (24h)
                </th>
                <th key="apr" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer transition-all duration-200 hover:bg-gray-700 hover:text-white">
                  APR
                </th>
                <th key="actions" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer transition-all duration-200 hover:bg-gray-700 hover:text-white">
                  Actions
                </th>
              </tr>
            </thead>
