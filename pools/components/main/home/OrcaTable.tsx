...
import { OrcaWhirlpoolType, TokenDataType } from "@/lib/types/home/orca";
  ...
  return (
    ...
    >
      ...
      <thead className="bg-gray-800 pb-4">
        <tr>
          <th key="pool" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            Pool
          </th>
          <th key="yield" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            Yield / TVL (24h)
          </th>
          <th key="volume" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            Volume 24H
          </th>
          <th key="tvl" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            TVL
          </th>
          <th key="fees" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            Fees 24H
          </th>
          <th key="rewards" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            Rewards 24H
          </th>
          <th key="actions" scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hover:bg-gray-700">
            Actions
          </th>
        </tr>
      </thead>
